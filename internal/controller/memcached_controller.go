...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Check if the Custom Resource for the Kind Memcached
	...
	if len(memcached.Status.Conditions) == 0 {
		...
		// raising the error "the object has been modified, please apply your changes to the latest version and try again"
	...
	// Ensure the Deployment size is the same as defined
